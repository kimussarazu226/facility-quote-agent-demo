...
const PRECHAT_SCRIPT = [
  {
    summaryTitle: "依頼文への追記",
    agent:
      "ここは<strong>依頼を出す側</strong>（施設管理・オーナー側のイメージ）が、各社に送る<strong>見積依頼の本文に一言足したいこと</strong>を書く欄です。<br><br>" +
      "例：立入可能時間の注意、現地担当の連絡先、前年度から変わった条件、見積書に載せてほしい備考、など。<br><br>" +
      "<strong>保守運営会社が入力する想定ではありません。</strong>実在するイオンディライトのような受注側の担当者が、この画面で打ち込む場面は通常ありません（依頼を受け取り、後工程で見積を返す立場です）。<br><br>" +
      "追記がなければ、<strong>未入力のまま送信</strong>で進めて大丈夫です。",
    suggestions: [
      "B1倉庫は22時以降のみ立入可、と本文に入れたい",
      "緊急時は施設直通 03-xxxx-xxxx まで",
    ],
  },
  {
    summaryTitle: "期限",
